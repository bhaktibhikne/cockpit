                ...
                <div className="modal-body">
                    <table className="form-table-ct">
                        ...
                        <tr>
                            ...
                            <td>
                                <Select.Select initial="One">
                                    <Select.SelectEntry data="One">TCP</Select.SelectEntry>
                                    <Select.SelectEntry data="Two">UDP</Select.SelectEntry>
                                    <Select.SelectEntry data="Three">ICMP</Select.SelectEntry>
                                </Select.Select>
                            </td>
                        </tr>
